...
/***/ "./resources/assets/admin/js/base/app.js":
/*!***********************************************!*\
  !*** ./resources/assets/admin/js/base/app.js ***!
  \***********************************************/
...
/***/ "./resources/assets/admin/js/base/layout.js":
/*!**************************************************!*\
  !*** ./resources/assets/admin/js/base/layout.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app */ "./resources/assets/admin/js/base/app.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var IH = /*#__PURE__*/function () {
  function IH() {
    ...
    IH.initResources();
    IH.handleCounterUp();
    IH.initMediaIntegrate();

    if (IHVariables && IHVariables.authorized === '0') {
  ...
  _createClass(IH, [{
    ...
    value: function countCharacter() {
      $.fn.charCounter = function (max, settings) {
        ...
        settings = $.extend({
          ...
          format: '(%1 ' + IHVariables.languages.system.character_remain + ')',
          pulse: true,
          delay: 0
        }, settings);
        var p, timeout;
    ...
    value: function handlePortletTools() {
      ...
      $('body').on('click', '.portlet > .portlet-title .fullscreen', function (event) {
        ...
        if (portlet.hasClass('portlet-fullscreen')) {
          ...
          var height = IH.getViewPort().height - portlet.children('.portlet-title').outerHeight() - parseInt(portlet.children('.portlet-body').css('padding-top')) - parseInt(portlet.children('.portlet-body').css('padding-bottom'));
    ...
    value: function showNotice(messageType, message) {
      ...
      if (!messageHeader) {
        switch (messageType) {
          case 'error':
            messageHeader = IHVariables.languages.notices_msg.error;
            break;

          case 'success':
            messageHeader = IHVariables.languages.notices_msg.success;
            break;
        }
      }
    ...
    value: function handleError(data) {
      if (typeof data.errors !== 'undefined' && !_.isArray(data.errors)) {
        IH.handleValidationError(data.errors);
      } else {
        if (typeof data.responseJSON !== 'undefined') {
          if (typeof data.responseJSON.errors !== 'undefined') {
            if (data.status === 422) {
              IH.handleValidationError(data.responseJSON.errors);
            }
          } else if (typeof data.responseJSON.message !== 'undefined') {
            IH.showError(data.responseJSON.message);
          } else {
    ...
    value: function initResources() {
      ...
      IH.initDatePicker('.datepicker');

      if (jQuery().mCustomScrollbar) {
        IH.callScroll($('.list-item-checkbox'));
      }
    ...
    value: function initCodeEditor(id) {
      ...
      $('.handle-tool-drag').mousedown(function (event) {
        ...
        $('body').attr('data-dragtool', _self.attr('id')).on('mousemove', IH.onDragTool);
        $(window).on('mouseup', IH.onReleaseTool);
      });
    }
  }, {
    key: "onDragTool",
    ...
    value: function onReleaseTool() {
      $('body').off('mousemove', IH.onDragTool);
      $(window).off('mouseup', IH.onReleaseTool);
    }
  }]);
...
(() => {
/*!*******************************************!*\
  !*** ./resources/assets/admin/js/core.js ***!
  \*******************************************/
__webpack_require__(/*! ./base/app */ "./resources/assets/admin/js/base/app.js");

__webpack_require__(/*! ./base/layout */ "./resources/assets/admin/js/base/layout.js");

__webpack_require__(/*! ./script */ "./resources/assets/admin/js/script.js");

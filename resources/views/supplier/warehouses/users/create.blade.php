    ...
    <div class="col-lg-6 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{translate(' Create User Warehouse Information')}}</h5>
            </div>

            <form class="form-horizontal" action="{{ route('supplier.warehouse.user.store') }}" method="POST" enctype="multipart/form-data">
            	@csrf
                <div class="card-body">

                ...
                @if(isAdmin() || in_array('27', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('admin.restaurants.branches.users.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.restaurants.branches.users.index','admin.restaurants.branches.users.create','admin.restaurants.branches.users.edit'])}}">

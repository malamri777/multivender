            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('admin.suppliers.warehouses.index')}}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['admin.suppliers.warehouses.index', 'admin.suppliers.warehouses.create', 'admin.suppliers.warehouses.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Warehouse List')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('admin.suppliers.users.index')}}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['admin.suppliers.users.index','admin.suppliers.users.create','admin.suppliers.users.edit'])}}">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('admin.restaurants.index')}}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['admin.restaurants.index', 'admin.restaurants.create','admin.restaurants.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Restaurant List')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('admin.restaurants.branches.index')}}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['admin.restaurants.branches.index', 'admin.restaurants.branches.create', 'admin.restaurants.branches.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Branch List')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('admin.restaurants.users.index')}}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['admin.restaurants.users.index','admin.restaurants.users.create','admin.restaurants.users.edit'])}}">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @endif
                        {{-- <li class="aiz-side-nav-item">
                            <a href="{{route('admin.digitalproducts.index')}}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['admin.digitalproducts.index', 'admin.digitalproducts.create', 'admin.digitalproducts.edit']) }}">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.business_settings.vendor_commission') }}"
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.blog-category.index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['admin.blog-category.create', 'admin.blog-category.edit'])}}">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @endphp
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.support_ticket.admin_index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['admin.support_ticket.admin_index', 'admin.support_ticket.admin_show'])}}">
                        ...
                        @endphp
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.conversations.admin_index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['admin.conversations.admin_index', 'admin.conversations.admin_show'])}}">
                                ...
                                <ul class="aiz-side-nav-list level-3">
                                    ...
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('admin.states.index')}}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['admin.states.index','admin.states.edit','admin.states.update'])}}">
                                    ...
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('admin.districts.index')}}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['admin.districts.index','admin.districts.edit','admin.districts.update'])}}">

            ...
            <tbody>
                @foreach($flash_deals as $key => $flash_deal)
                    <tr>
						...
						<td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('admin.flash_deals.edit', ['id'=>$flash_deal->id, 'lang'=>config('myenv.DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">

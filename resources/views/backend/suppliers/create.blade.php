    ...
    <div class="col-lg-6 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{translate('Create Supplier Information')}}</h5>
            </div>

            <form class="form-horizontal" action="{{ route('admin.suppliers.store') }}" method="POST" enctype="multipart/form-data">
            	@csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <small class="text-muted">{{translate('Logo of the supplier. Use 600x600 sizes images.')}}</small>
                        </div>
                    </div>

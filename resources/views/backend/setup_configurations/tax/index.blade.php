            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('admin.tax.destroy', $tax->id)}}" title="{{ translate('Delete') }}">
    ...
    <div id="add-tax" class="modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal"  action="{{ route('admin.tax.store') }}" method="POST">
                    @csrf

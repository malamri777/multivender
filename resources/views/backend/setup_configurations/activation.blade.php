    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    You need to configure SMTP correctly to enable this feature. <a href="{{ route('admin.smtp_settings.index') }}">Configure Now</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    You need to configure Stripe correctly to enable this feature. <a href="{{ route('admin.payment_method.index') }}">Configure Now</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    You need to configure Mercadopago correctly to enable this feature. <a href="{{ route('admin.payment_method.index') }}">Configure Now</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    You need to configure SSlCommerz correctly to enable this feature. <a href="{{ route('admin.payment_method.index') }}">Configure Now</a>
                </div>
            </div>
        </div>
    </div>

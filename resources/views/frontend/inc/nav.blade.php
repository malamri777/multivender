            ...
            <div class="col-5 text-right d-none d-lg-block">
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    ...
                    @auth
                        ...
                        <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                            @if (Auth::user()->hasPermission('admin_dashboard-view'))
                                <a href="{{ route('admin.dashboard') }}" class="text-reset d-inline-block opacity-60 py-2">{{ translate('My Panel')}}</a>
                            @elseif (Auth::user()->hasPermission('supplier_dashboard-view'))
                                <a href="{{ route('supplier.dashboard') }}" class="text-reset d-inline-block opacity-60 py-2">{{ translate('My Panel')}}</a>
                            @else

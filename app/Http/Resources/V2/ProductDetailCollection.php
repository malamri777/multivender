        ...
        return [
            'data' => $this->collection->map(function ($data) {
                ...
                return [
                    ...
                    'shop_id' => $data->added_by == 'admin' ? 0 : $data->user->supplier->id,
                    'shop_name' => $data->added_by == 'admin' ? translate('In House Product') : $data->user->supplier->name,
                    'shop_logo' => $data->added_by == 'admin' ? uploaded_asset(get_setting('header_logo')) : uploaded_asset($data->user->supplier->logo)??"",
                    'photos' => $photos,

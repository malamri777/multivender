...
class BranchUserControlle extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.restaurants.branchUser.users.index', compact('sort_search', 'sort_branch', 'usersBranch'));
    }

    public function create()
    {
        $restaurants = Restaurant::get();
        return view('backend.restaurants.branchUser.users.create', compact('restaurants'));
    }
    ...
    public function edit($id)
    {
        ...
        $branchIds = $branchUser->branches->pluck('id') ?? [];
        $restaurants = Restaurant::get();
        return view('backend.restaurants.branchUser.users.edit', compact('branchUser', 'restaurants', 'branchIds'));
    }

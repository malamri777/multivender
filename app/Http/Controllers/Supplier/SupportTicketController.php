...
class SupportTicketController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('supplier.support_ticket.index', compact('tickets'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($ticket->save()){
            ...
            return redirect()->route('supplier.support_ticket.index');
        }
        else{
    ...
    public function send_support_mail_to_admin($ticket){
        ...
        $array['link'] = route('admin.support_ticket.admin_show', encrypt($ticket->id));
    ...
    public function show($id)
    {
        ...
        return view('supplier.support_ticket.show', compact('ticket','ticket_replies'));
    }

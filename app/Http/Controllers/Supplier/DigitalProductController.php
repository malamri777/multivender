...
class DigitalProductController  extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('supplier.product.digitalproducts.index', compact('products'));
    }
    ...
    public function create()
    {
        if(addon_is_activated('seller_subscription')){
            if(seller_package_validity_check()){
                ...
                return view('supplier.product.digitalproducts.create', compact('categories'));
            }
            else {
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('supplier.product.digitalproducts.edit', compact('categories', 'product', 'lang'));
    }
